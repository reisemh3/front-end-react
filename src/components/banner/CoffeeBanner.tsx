...
const CoffeeBanner = () => {
    ...
    return (
        <div className="coffee-banner">
                Please consider donating by <a className="banner-link" target="_blank" rel="noreferrer" href="https://www.buymeacoffee.com/veiset">buying me a coffee</a> to keep this webpage ad-free and privacy friendly
